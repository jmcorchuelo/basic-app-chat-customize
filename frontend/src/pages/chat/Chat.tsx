                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle} style={{marginTop: '20px'}}>Nire izena TEKNA da, eguneroko bizitzan hobetzeko zure laguntzailea..</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={styles.chatInput}>
                            {isLoading && (
                                <Stack 
                                    ...
                                    role="button"
                                    aria-label="Parar generación de respuesta"
                                    tabIndex={0}
